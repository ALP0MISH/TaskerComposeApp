...
import com.example.composetaskerapp.cammon.extensions.toHexCode
...
fun AddTaskCategoryScreen(
    ...
    Column(
        ...
        HarmonyColorPicker(
            ...
            currentColor = color
            extraColor = color.getColors(colorHarmonyMode = ColorHarmonyMode.ANALOGOUS)
            val color = extraColor.firstOrNull() ?: return@HarmonyColorPicker
